...
namespace test {
		...
		m_TranslationA(glm::vec3(200, 200, 0)), m_TranslationB(glm::vec3(400, 200, 0))
	{
		...
		m_Texture = std::make_unique<Texture>("res/textures/P1.jpg");
	}
	...
	void TestTexture2D::OnImGuiRender()
	{
		...
		ImGui::SliderFloat3("m_TranslationA", &m_TranslationA.x, 0.0f, SCR_WIDTH);
		ImGui::SliderFloat3("m_TranslationB", &m_TranslationB.x, 0.0f, SCR_WIDTH);
